...
export const NewMarriageDetails = () => {
  ...
  const [showPreviousSpouseInfo, setShowPreviousSpouseInfo] =
    useState<boolean>(false);

  const handleSwitchChange = (checked: boolean) => {
    setShowPreviousSpouseInfo(checked);
  };

  const [showPhysicalAddress, setShowPhysicalAddress] =
    useState<boolean>(false);
  const handleAddressSwitchChange = (checked: boolean) => {
    setShowPhysicalAddress(checked);
  };
  return (
