  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center p-4 lg:gap-10">
      <div className="w-full lg:w-1/2">
        ...
        <div className="w-full my-2">
          <h2 className="p-1">Will you be applying with you partner?</h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
        <div className="w-full my-2">
          <h2 className="p-1">Marriage Certificate Available?</h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
        <div className="w-full my-2">
          <h2 className="p-1">Email Address (2)</h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
        <div className="my-2">
          <h2 className="my-3 p-1">Spouse Name(s)</h2>
        ...
        <div className="w-full my-2">
          <h2 className="p-1"> Spouse's Email Address </h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
        <div className="w-full my-2">
          <h2 className="p-1"> Spouse's Phone Number</h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="w-full my-2">
          <h2 className="p-1">Countries of Citizenship</h2>
          <p className="applicantDetailsSinglePTag"></p>
        </div>
        <div className="w-full my-2">
        ...
        <div className="my-2">
          <h2 className="my-3 p-1">Previous Spouse(s)</h2>
          <div className="flex flex-col gap-5 my-2">
            <div className="flex flex-col lg:flex-row gap-5 w-full ">
              <div className=" lg:w-1/2">
                <p className="applicantDetailsPTag"> Date of Marriage</p>
              </div>
              <div className="lg:w-1/2">
                <p className="applicantDetailsPTag"> Date of Marriage</p>
              </div>
