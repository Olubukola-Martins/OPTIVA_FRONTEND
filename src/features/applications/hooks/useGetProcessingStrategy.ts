...
export const QUERY_KEY_FOR_PROCESSING_STRATEGY_AND_STEPS = "processingStrategyAndSteps";

const getData = async (props: { token: string , id:number}): Promise<IGetProcessingStrategy[]> => {
